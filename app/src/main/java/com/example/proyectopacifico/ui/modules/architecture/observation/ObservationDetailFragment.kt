...
class ObservationDetailFragment : Fragment(R.layout.fragment_observation_detail) {

    private lateinit var binding: FragmentObservationDetailBinding

    private val args by navArgs<ObservationDetailFragmentArgs>()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding = FragmentObservationDetailBinding.bind(view)
