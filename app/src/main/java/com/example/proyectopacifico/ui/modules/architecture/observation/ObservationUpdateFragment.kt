...
class ObservationUpdateFragment : Fragment(R.layout.fragment_observation_update) {

    private lateinit var binding: FragmentObservationUpdateBinding

    private val args by navArgs<ObservationUpdateFragmentArgs>()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding = FragmentObservationUpdateBinding.bind(view)
    ...
    private fun clicks() {
        ...
        binding.btnUpdateObservation.setOnClickListener { obtainAnswers() }
    }
