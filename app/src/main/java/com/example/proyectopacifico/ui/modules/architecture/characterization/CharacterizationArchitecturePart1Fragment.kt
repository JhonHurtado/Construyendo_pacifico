...
import com.example.proyectopacifico.databinding.FragmentCharacterizationArchitecturePart1Binding
...
class CharacterizationArchitecturePart1Fragment :
    Fragment(R.layout.fragment_characterization_architecture_part1) {

    private lateinit var binding: FragmentCharacterizationArchitecturePart1Binding

    private val args by navArgs<CharacterizationArchitecturePart1FragmentArgs>()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding = FragmentCharacterizationArchitecturePart1Binding.bind(view)
        ...
        if (false in validateForm()) {
            ...
            for (i in optionList.indices) {
                if (optionList[i].second == "editText") {
                    if ((optionList[i].first as EditText).text.toString().isNotEmpty()
                    ) answersList.add(
                        AnswersEntity(
                            0,
    ...
    private fun clicks() {
        ...
        binding.btnSaveCharacterisation.setOnClickListener { obtainAnswers() }
    }
